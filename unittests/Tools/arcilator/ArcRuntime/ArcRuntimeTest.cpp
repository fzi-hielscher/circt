...
TEST(ArcRuntimeTest, AllocDealloc) {
...
TEST(ArcRuntimeTest, AllocDeallocIR) {
  ...
  bogusModel.modelName = "bogus";
  bogusModel.numStateBytes = bogusStateBytes;
  uint8_t *modelState = api.allocInstance(&bogusModel, nullptr);
