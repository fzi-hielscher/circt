...
// RUN: circt-opt --test-apply-lowering-options='lowering-options=disallowLocalVariables' --export-verilog %s | FileCheck %s --check-prefix=DISALLOW -strict-whitespace
