// RUN: circt-opt %s --test-apply-lowering-options='lowering-options=emittedLineLength=100,emitBindComments' -export-verilog -split-input-file -o %t.mlir | FileCheck %s
