// RUN: arcilator %s --run --jit-entry=main --jit-no-runtime               | FileCheck --match-full-lines --check-prefixes=CHECK,DBGOFF %s
// RUN: arcilator %s --run --jit-entry=main                                | FileCheck --match-full-lines --check-prefixes=CHECK,DBGOFF %s
// RUN: arcilator %s --run --jit-entry=main --jit-runtime-args="foo"       | FileCheck --match-full-lines --check-prefixes=CHECK,DBGOFF %s
// RUN: arcilator %s --run --jit-entry=main --jit-runtime-args="debug"     | FileCheck --match-full-lines --check-prefixes=CHECK,DBGON  %s
// RUN: arcilator %s --run --jit-entry=main --jit-runtime-args="foo;debug" | FileCheck --match-full-lines --check-prefixes=CHECK,DBGON  %s
...
// DBGOFF-NOT: [ArcRuntime] Deleting instance of model "flipflop" with ID 0
// DBGON-NEXT: [ArcRuntime] Deleting instance of model "flipflop" with ID 0
...
// DBGOFF-NOT: [ArcRuntime] Deleting instance of model "flipflop" with ID 1
// DBGON-NEXT: [ArcRuntime] Deleting instance of model "flipflop" with ID 1
